...
/*
 ...
 This is an extension of the basic ofImage, allowing:
	...
	this will work automatically if you draw from the supplied mpImage::draw();
	...
	learn by example:
		...
		void testApp::newResponse(mpImage& img){
...
#define IMG_DOWNLOAD_FOLDER_NAME "mpImageDownloads"
...
class mpImage : public ofThread, public ofImage {
	...
	public:
		...
		ofEvent<string>			imageLoadedStatus;
		bool					errorLoaded;
		bool					clickable;
		bool					bLoadError;
	...
	//(bigger side), then we shrink it down to fit this new size (for the largest side)
		...
		//If you call mpImage::draw(), there's no need to use this
		...
		ofEvent<mpImageEvent>		imageReadyEvent;
